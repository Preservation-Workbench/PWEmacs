...
;; TODO: Sjekk kommandoer under mot de over. Finnes det forbedrede doom varianter som bør brukes?
 ;; Force override:
(bind-key* (kbd "C-c") #'kill-ring-save)
(bind-key* (kbd "C-x") #'kill-region)
;;(bind-key* (kbd "C-v") #'yank)

;; TODO: Legg til # foran kommandoer under
(map!
 ;(:map override
; TODO: Test å overstyre noen av de med problemer under. Samme som bind-key* over ?
  ;)
    ...
    ;; TODO: Finn bedre kommandoer mm for mc
    ...
    ;; TODO: Bare den under for C-q direkte? Siden ikke bruker daemon nå? Men bruker server -> hva da?
    "C-S-q"                       'save-buffers-kill-emacs
    "C-S-s"                       'write-file
...
;; TODO: Eksempel på bruk av hercules -> finn flere
(hercules-def
